...
func CreateAvatar(name string) []byte {
	...
	hair := "#" + Colors[hash%uint32(len(Colors))]
	skin := "#" + Skins[(hash/3)%uint32(len(Skins))]
	clothes := "#" + Colors[(hash/7)%uint32(len(Colors))]

	svg := `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 360" fill="none" shape-rendering="auto">
  ...
  <g mask="url(#viewboxMask)">
    <g transform="translate(80 23)">
      <path d="M154 319.5c-14.4-20-25.67-58.67-27-78L58.5 212 30 319.5h124Z" fill="skin" stroke="#000"
        stroke-width="4" />
      <path
      ...
      <path
        ...
        fill="skin" stroke="#000" stroke-width="4" />
    </g>
    <g transform="translate(170 183)">
      <path
        d="M64.73 25.7a36 36 0 0 0 1.18-12.54 4.98 4.98 0 0 0-6.8-4.2c-4.26 1.67-18.03 6.88-27.62 8.2-10.52 1.44-26.66-.32-31.44-.91a4.98 4.98 0 0 0-5.53 5.74 36 36 0 0 0 70.21 3.7Z"
        fill="#000000" />
      <path d="M51.83 39.55a32 32 0 0 1-37.2 4.62 21.5 21.5 0 0 1 37.2-4.62Z" fill="#FC909F" />
    </g>
    <g transform="translate(110 102)">
      <path d="M99 10.21c5.67-2.66 19-5.1 27 6.5M23.58 35.52c2.07-5.9 9.68-17.12 23.56-14.7" stroke="#000000"
        stroke-width="4" stroke-linecap="round" />
    </g>
    <g transform="translate(49 11)">
      <path
        d="M123.79 17.49H123.94a96.78 96.78 0 0 1 62.07 24.36c14.06 12.4 22.45 26.87 25.19 36.73-4.06 2.32-11.01 4.31-19.88 5.95-9.68 1.78-21.3 3.08-33.15 4.01-23.7 1.86-48.2 2.2-59.63 1.96l-6.07-.13 4.8 3.71c2.5 1.93 5.83 3.28 9.34 4.22 3.55.95 7.42 1.54 11.14 1.87 3.82.34 7.55.42 10.64.34-10.59 8.16-24.06 14.44-37.35 19.09a225.88 225.88 0 0 1-39.83 9.92l-2.15.32.5 2.11c3.34 14.43 9.5 39.65 13.62 56.57 1.83 7.5 3.26 13.38 3.87 15.94 1.09 4.56 4.5 11.05 8.4 17.03 3.6 5.52 7.78 10.89 11.32 14.2l-7.84 31.81H49.37c8.34-12.71 10.1-27.4 8.4-42.98-1.84-16.87-7.76-35-14-53.17l-1.85-5.36c-5.69-16.46-11.36-32.88-14.43-48.6-3.4-17.44-3.56-33.75 2.83-48.09 10.34-23.21 28.66-36.7 47-44.12 18.37-7.45 36.61-8.76 46.46-7.71Z"
        fill="hair" stroke="#000" stroke-width="4" />
    </g>
    ...
    <g transform="translate(53 272)">
      <g stroke="#000" stroke-width="4">
        ...
        <path
          ...
          fill="#000" stroke-linejoin="round" />
      </g>
    </g>
  </g>
</svg>`

	svg = strings.NewReplacer("hair", hair, "skin", skin, "clothes", clothes).Replace(svg)
